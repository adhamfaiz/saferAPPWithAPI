...
class myotp_screen extends StatefulWidget {
  const myotp_screen({required this.myauth}) ;
 final EmailOTP myauth ;

  @override
  State<myotp_screen> createState() => _myotp_screenState();
}

// ignore: camel_case_types
class _myotp_screenState extends State<myotp_screen> {
        ...
        children: [
          ...
          ElevatedButton(
            ...
            if (await widget.myauth.verifyOTP(otp: otp1Controller.text +
                    otp2Controller.text +
                    otp3Controller.text +
                    otp4Controller.text+ otp5Controller.text+ otp6Controller.text) == true) {
